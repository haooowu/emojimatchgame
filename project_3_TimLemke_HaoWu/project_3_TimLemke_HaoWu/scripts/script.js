...
$(function() {
	...
	*/
	...
	// if easy, shuffleboard(8)
	// if mid, shuffleboard(..)
	// if hard, shuffleboard(..)
	...
	$("button").click(function(event){
		...
		setTimeout(function() {
			$("li").removeClass('flip');
			//*
			//* if differnet button, reshuffle
			//*
			//http://blog.teamtreehouse.com/using-jquery-to-detect-when-css3-animations-and-transitions-end
			// $("li").one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', function() {
			// 	$("#board").empty();
			// 	shuffleBoard();
			// });
		}, 1000);
